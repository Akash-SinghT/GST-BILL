    ...
    <div id="aboutus" className="py-8 px-4 sm:px-8 lg:px-16 lg:py-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-center mt-10">
        ...
        <div className="text-center sm:text-start lg:ml-16">
          ...
          <h2 className="font-bold text-2xl sm:text-4xl lg:text-6xl mt-4">
            Simplifying Billing For Your Growing Business.
          </h2>
          <p className="text-lg sm:text-xl text-gray-600 lg:mt-7 mt-5">
            GoGSTBill is a product of FinSync Technolabs Private Limited. We are
            based in Ahmedabad, Gujarat.
          </p>
          <p className="text-lg sm:text-xl text-gray-600 lg:mt-8 mt-5">
